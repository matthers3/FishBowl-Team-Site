...
export default function OurValues() {
    ...
    in South America.
    <br/><br/>
    <strong className="alma">✨ This is also extremely important to us ✨</strong>
    </p>,
    ...
    in South America.
    <br/><br/>
    <strong className="alma">✨ This is also extremely <br/>important to us ✨</strong>
    </p>,
    ...
    p4: <p className="text">
        ...
        (source). In this case, it’s both at the same time.
    </p>
    }
